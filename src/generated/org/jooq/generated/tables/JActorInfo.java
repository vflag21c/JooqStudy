...
public class JActorInfo extends TableImpl<ActorInfoRecord> {
     ...
     */
    public final TableField<ActorInfoRecord, UShort> ACTOR_ID = createField(DSL.name("actor_id"), SQLDataType.SMALLINTUNSIGNED.nullable(false).defaultValue(DSL.inline("0", SQLDataType.SMALLINTUNSIGNED)), this, "");
