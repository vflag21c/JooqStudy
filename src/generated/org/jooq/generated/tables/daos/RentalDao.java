...
public class RentalDao extends DAOImpl<RentalRecord, Rental, Integer> {
     ...
     * upperInclusive</code>
     */
    public List<Rental> fetchRangeOfJCustomerId(UShort lowerInclusive, UShort upperInclusive) {
     ...
     */
    public List<Rental> fetchByJCustomerId(UShort... values) {
     ...
     * upperInclusive</code>
     */
    public List<Rental> fetchRangeOfJStaffId(UByte lowerInclusive, UByte upperInclusive) {
     ...
     */
    public List<Rental> fetchByJStaffId(UByte... values) {
