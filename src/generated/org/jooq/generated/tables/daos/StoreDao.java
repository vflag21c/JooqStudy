...
public class StoreDao extends DAOImpl<StoreRecord, Store, UByte> {
    ...
    @Override
    public UByte getId(Store object) {
     ...
     * upperInclusive</code>
     */
    public List<Store> fetchRangeOfJStoreId(UByte lowerInclusive, UByte upperInclusive) {
     ...
     */
    public List<Store> fetchByJStoreId(UByte... values) {
     ...
     */
    public Store fetchOneByJStoreId(UByte value) {
     ...
     * Fetch a unique record that has <code>store_id = value</code>
     */
    public Optional<Store> fetchOptionalByJStoreId(UByte value) {
     ...
     * upperInclusive</code>
     */
    public List<Store> fetchRangeOfJManagerStaffId(UByte lowerInclusive, UByte upperInclusive) {
     ...
     */
    public List<Store> fetchByJManagerStaffId(UByte... values) {
     ...
     */
    public Store fetchOneByJManagerStaffId(UByte value) {
     ...
     * Fetch a unique record that has <code>manager_staff_id = value</code>
     */
    public Optional<Store> fetchOptionalByJManagerStaffId(UByte value) {
     ...
     * upperInclusive</code>
     */
    public List<Store> fetchRangeOfJAddressId(UShort lowerInclusive, UShort upperInclusive) {
     ...
     */
    public List<Store> fetchByJAddressId(UShort... values) {
