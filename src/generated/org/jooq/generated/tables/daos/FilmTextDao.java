...
public class FilmTextDao extends DAOImpl<FilmTextRecord, FilmText, Short> {
    ...
    @Override
    public Short getId(FilmText object) {
     ...
     * upperInclusive</code>
     */
    public List<FilmText> fetchRangeOfJFilmId(Short lowerInclusive, Short upperInclusive) {
     ...
     */
    public List<FilmText> fetchByJFilmId(Short... values) {
     ...
     */
    public FilmText fetchOneByJFilmId(Short value) {
     ...
     * Fetch a unique record that has <code>film_id = value</code>
     */
    public Optional<FilmText> fetchOptionalByJFilmId(Short value) {
