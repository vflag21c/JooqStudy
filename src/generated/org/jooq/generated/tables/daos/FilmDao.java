...
public class FilmDao extends DAOImpl<FilmRecord, Film, UShort> {
    ...
    @Override
    public UShort getId(Film object) {
     ...
     * upperInclusive</code>
     */
    public List<Film> fetchRangeOfJFilmId(UShort lowerInclusive, UShort upperInclusive) {
     ...
     */
    public List<Film> fetchByJFilmId(UShort... values) {
     ...
     */
    public Film fetchOneByJFilmId(UShort value) {
     ...
     * Fetch a unique record that has <code>film_id = value</code>
     */
    public Optional<Film> fetchOptionalByJFilmId(UShort value) {
     ...
     * upperInclusive</code>
     */
    public List<Film> fetchRangeOfJLanguageId(UByte lowerInclusive, UByte upperInclusive) {
     ...
     */
    public List<Film> fetchByJLanguageId(UByte... values) {
     ...
     */
    public List<Film> fetchRangeOfJOriginalLanguageId(UByte lowerInclusive, UByte upperInclusive) {
     ...
     */
    public List<Film> fetchByJOriginalLanguageId(UByte... values) {
