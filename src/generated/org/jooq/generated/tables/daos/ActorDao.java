...
public class ActorDao extends DAOImpl<ActorRecord, Actor, UShort> {
    ...
    @Override
    public UShort getId(Actor object) {
     ...
     * upperInclusive</code>
     */
    public List<Actor> fetchRangeOfJActorId(UShort lowerInclusive, UShort upperInclusive) {
     ...
     */
    public List<Actor> fetchByJActorId(UShort... values) {
     ...
     */
    public Actor fetchOneByJActorId(UShort value) {
     ...
     * Fetch a unique record that has <code>actor_id = value</code>
     */
    public Optional<Actor> fetchOptionalByJActorId(UShort value) {
