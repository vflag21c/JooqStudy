...
public class CustomerDao extends DAOImpl<CustomerRecord, Customer, UShort> {
    ...
    @Override
    public UShort getId(Customer object) {
     ...
     * upperInclusive</code>
     */
    public List<Customer> fetchRangeOfJCustomerId(UShort lowerInclusive, UShort upperInclusive) {
     ...
     */
    public List<Customer> fetchByJCustomerId(UShort... values) {
     ...
     */
    public Customer fetchOneByJCustomerId(UShort value) {
     ...
     * Fetch a unique record that has <code>customer_id = value</code>
     */
    public Optional<Customer> fetchOptionalByJCustomerId(UShort value) {
     ...
     * upperInclusive</code>
     */
    public List<Customer> fetchRangeOfJStoreId(UByte lowerInclusive, UByte upperInclusive) {
     ...
     */
    public List<Customer> fetchByJStoreId(UByte... values) {
     ...
     * upperInclusive</code>
     */
    public List<Customer> fetchRangeOfJAddressId(UShort lowerInclusive, UShort upperInclusive) {
     ...
     */
    public List<Customer> fetchByJAddressId(UShort... values) {
