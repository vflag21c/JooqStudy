...
public class PaymentDao extends DAOImpl<PaymentRecord, Payment, UShort> {
    ...
    @Override
    public UShort getId(Payment object) {
     ...
     * upperInclusive</code>
     */
    public List<Payment> fetchRangeOfJPaymentId(UShort lowerInclusive, UShort upperInclusive) {
     ...
     */
    public List<Payment> fetchByJPaymentId(UShort... values) {
     ...
     */
    public Payment fetchOneByJPaymentId(UShort value) {
     ...
     * Fetch a unique record that has <code>payment_id = value</code>
     */
    public Optional<Payment> fetchOptionalByJPaymentId(UShort value) {
     ...
     * upperInclusive</code>
     */
    public List<Payment> fetchRangeOfJCustomerId(UShort lowerInclusive, UShort upperInclusive) {
     ...
     */
    public List<Payment> fetchByJCustomerId(UShort... values) {
     ...
     * upperInclusive</code>
     */
    public List<Payment> fetchRangeOfJStaffId(UByte lowerInclusive, UByte upperInclusive) {
     ...
     */
    public List<Payment> fetchByJStaffId(UByte... values) {
