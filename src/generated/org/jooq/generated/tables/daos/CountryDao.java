...
public class CountryDao extends DAOImpl<CountryRecord, Country, UShort> {
    ...
    @Override
    public UShort getId(Country object) {
     ...
     * upperInclusive</code>
     */
    public List<Country> fetchRangeOfJCountryId(UShort lowerInclusive, UShort upperInclusive) {
     ...
     */
    public List<Country> fetchByJCountryId(UShort... values) {
     ...
     */
    public Country fetchOneByJCountryId(UShort value) {
     ...
     * Fetch a unique record that has <code>country_id = value</code>
     */
    public Optional<Country> fetchOptionalByJCountryId(UShort value) {
