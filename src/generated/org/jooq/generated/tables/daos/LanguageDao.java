...
public class LanguageDao extends DAOImpl<LanguageRecord, Language, UByte> {
    ...
    @Override
    public UByte getId(Language object) {
     ...
     * upperInclusive</code>
     */
    public List<Language> fetchRangeOfJLanguageId(UByte lowerInclusive, UByte upperInclusive) {
     ...
     */
    public List<Language> fetchByJLanguageId(UByte... values) {
     ...
     */
    public Language fetchOneByJLanguageId(UByte value) {
     ...
     * Fetch a unique record that has <code>language_id = value</code>
     */
    public Optional<Language> fetchOptionalByJLanguageId(UByte value) {
