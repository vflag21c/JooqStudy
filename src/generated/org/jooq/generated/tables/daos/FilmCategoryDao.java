...
public class FilmCategoryDao extends DAOImpl<FilmCategoryRecord, FilmCategory, Record2<UShort, UByte>> {
    ...
    @Override
    public Record2<UShort, UByte> getId(FilmCategory object) {
     ...
     * upperInclusive</code>
     */
    public List<FilmCategory> fetchRangeOfJFilmId(UShort lowerInclusive, UShort upperInclusive) {
     ...
     */
    public List<FilmCategory> fetchByJFilmId(UShort... values) {
     ...
     * upperInclusive</code>
     */
    public List<FilmCategory> fetchRangeOfJCategoryId(UByte lowerInclusive, UByte upperInclusive) {
     ...
     */
    public List<FilmCategory> fetchByJCategoryId(UByte... values) {
