...
public class JFilmList extends TableImpl<FilmListRecord> {
     ...
     */
    public final TableField<FilmListRecord, UShort> FID = createField(DSL.name("FID"), SQLDataType.SMALLINTUNSIGNED.defaultValue(DSL.inline("0", SQLDataType.SMALLINTUNSIGNED)), this, "");
